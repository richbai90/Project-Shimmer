...
export const IconUmbrella : React.SFC<{}> = () => (
  <svg
    className="umbrella"
...
export const CheckboxGreyIcon : React.SFC<{}> = () => (
  <svg
    className="icon"
    width="100%"
    height="100%"
  ...
  >
    ...
    <path
      fill="#939598"
      d="M462.3,493.3H30.6c-11.9,0-21.6-9.7-21.6-21.6V29.9C9,18,18.7,8.3,30.6,8.3h441.8c11.9,0,21.6,9.7,21.6,21.6 v431.7C494,479,479.7,493.3,462.3,493.3z"
    />
...
export const SaveButton : React.SFC<IconProps> = ({
  style = {},
  fill = "#E0E0E0",
  width = "100%",
  viewBox = "0 0 100 43"
  ...
  return (
    ...
    >
      ...
      />
      <path d="M32.1,12.9H16.7c-1.2,0-2.2,1-2.2,2.2v18.3c0,1.2,1,2.2,2.2,2.2H35c1.2,0,2.2-1,2.2-2.2V18L32.1,12.9z M17,15.2h12.7v5.3H17 V15.2z M26.7,33.3c-2.7,0.4-5-1.9-4.6-4.6c0.3-1.7,1.6-3.1,3.3-3.3c2.7-0.4,5,1.9,4.6,4.6C29.7,31.7,28.4,33.1,26.7,33.3z" />
      <text style={styles.font} transform="matrix(1 0 0 1 41.9499 31.5611)">
        SAVE
      </text>
    </svg>
  );
};
export const DefaultButton : React.SFC<IconProps> = ({
  style = {},
  fill = "#42A5F5",
  width = "100%",
  viewBox = "0 0 50 28"
  ...
  return (
    ...
    >
      <path
        fill={fill}
        d="M47.6,26H2.2c-1.1,0-1.9-0.9-1.9-1.9V2.2c0-1.1,0.9-1.9,1.9-1.9h45.4c1.1,0,1.9,0.9,1.9,1.9V24"
      />
      <text transform="matrix(1 0 0 1 9.1064 15.9219)" style={styles.words}>
        BUTTON
      </text>
    </svg>
  );
};
export const RadioButtonBlue : React.SFC<IconProps> = ({
  style = {},
  fill = "#4288DE",
  width = "100%",
  viewBox = "0 0 100 100"
  ...
  >
    <path
      fill={fill}
      d="M49.8,0.8C22.6,0.8,0.6,22.9,0.6,50c0,27.2,22,49.2,49.2,49.2C77,99.2,99,77.2,99,50C99,22.9,77,0.8,49.8,0.8z M49.8,89.6c-21.9,0-39.6-17.7-39.6-39.6c0-21.9,17.7-39.6,39.6-39.6S89.4,28.2,89.4,50C89.4,71.9,71.7,89.6,49.8,89.6z"
    />
    <circle fill={fill} cx="49.8" cy="50" r="24.6" />
  </svg>
);
export const CheckboxCustIcon : React.SFC<IconProps> = ({
  color = "#231F20",
  style = {},
  width = "100%",
  className = "",
  ...
  >
    ...
    <polygon
      style={{ fill: "#FFFFFF" }}
      points="226.391,315.931 397.157,145.718 362.353,110.915 192.152,281.973 115.17,204.71 83.34,236.54 194.561,347.761 "
    />
  </svg>
);
export const Trashcan : React.SFC<IconProps> = ({
  color = "#FFA103",
  style = {},
  width = "100%",
  className = "",
  ...
  >
    <path
      fill={color}
      d="M201.371,58.316h85.018c3.311,0,6.486,1.315,8.827,3.656l14.772,14.772h53.078 c7.034,0,12.736,5.702,12.736,12.736v25.173H110.967V90.024c0-7.044,5.71-12.753,12.753-12.753h53.06l14.132-14.536 C193.659,59.91,197.431,58.316,201.371,58.316z"
    />
    <path
      fill={color}
      d="M129.395,134.66l226.926-0.527v228.529c0,20.328-16.504,36.794-36.832,36.747l-152.884-0.355 c-20.564-0.048-37.21-16.732-37.21-37.296V134.66z"
    />
  </svg>
);
export const TrashcanCircle : React.SFC<IconProps> = ({
  color = "#FFA103",
  style = {},
  width = "100%",
  className = "",
...
export const UploadFileButton : React.SFC<IconProps> = ({
  style = {},
  width = "100%",
  className = "",
  viewBox = "0 0 85 20"
  ...
  return (
    ...
    >
      ...
      <text transform="matrix(1 0 0 1 7.4407 14.0189)" style={styles.st2}>
        Choose File
      </text>
    </svg>
  );
};
export const TriangleRightPointing : React.SFC<IconProps> = ({
  style = {},
  fill = "#FFA103",
  width = "100%",
  className = "",
...
export const TelephoneIcon : React.SFC<IconProps> = ({
  style = {},
  fill = "#000",
  width = "100%",
  className = "",
...
export const DropdownMenuDetails : React.SFC<IconProps> = ({
  color = "#000",
  style = {},
  width = "100%",
  className = "",
  ...
  return (
    ...
    >
      <g>
        <path
          style={styles.st2}
          d="M423.385,125.207l-18.734-18.734c-1.549-1.549-0.452-4.197,1.738-4.197h37.467c2.19,0,3.287,2.648,1.738,4.197 l-18.734,18.734C425.902,126.167,424.345,126.167,423.385,125.207z"
        />
        <rect
          x="59.115"
          y="192.353"
...
export const DropdownMenuSimple : React.SFC<IconProps>  = ({
  color = "#000000",
  style = {},
  width = "100%",
  className = "",
